...
const Home: NextPage = () => {
    ...
    const bmpChildren = <p><a href={bmpHref} target={"_blank"}>Web version</a> of <a href={bmpPdf} target={"_blank"}>the PDF published (and passed by the JC Planning Board) in 2019</a>.</p>
    const projects: Project[] = [
        ...
        { id: "turnpiketrap", title: "Rally opposing NJ Turnpike Expansion", href: "https://neighbor-ryan.org/turnpiketrap", src: "dsLHqLm5C3w", yt: true, alt: "", children: <p>Videos and transcripts from an anti-turnpike-widening rally on November 12, 2022. See also <a href={"https://turnpiketrap.org"} target={"_blank"}>turnpiketrap.org</a>.</p> },
                ...
                </Parallax>
                {
                    projects.map(
                        ({ id, href, title, yt, src, alt, children, }) => <>
                            <h1 id={id}><a href={href} target={"_blank"}>{title}</a></h1>
                            {children}
