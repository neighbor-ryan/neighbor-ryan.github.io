...
const Home: NextPage = () => {
    ...
    const projects: Project[] = [
        ...
        { id: "njsp", title: "NJ Traffic Crash Data", href: crashesUrl, src: "https://crashes.hudcostreets.org/plots/fatalities_per_year_by_type.png", alt: "Plot of NJ car crash deaths, 2008 to present", children: <p><A href={crashesUrl}><strong>{crashesDomain}</strong></A>: analysis of NJ State Police and NJDOT crash data</p>, },
        { id: "ctbk", title: "Citi Bike Dashboard", href: "https://ctbk.dev", src: "https://ctbk.dev/plots/month_counts.png", alt: "Plot of Citi Bike rides per month", children: <p><A href={"https://ctbk.dev"}><strong>ctbk.dev</strong></A>: interactive plots and stats about Citi Bike usage in NYC, Jersey City, and Hoboken.</p>},
